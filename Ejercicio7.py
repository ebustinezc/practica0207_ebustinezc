# El fichero calificaciones.csv contiene las calificaciones de un curso. Durante el curso se realizan dos exámenes parciales de teoría y un examen de prácticas. 
# Los alumnos que tengan menos de 4 en alguno de estos exámenes pueden repetirlo al final del curso (convocatoria ordinaria). 
...
# y otra con los alumnos suspensos. Para aprobar el curso, la asistencia tiene que ser mayor o igual que el 75%, la nota de los exámenes parciales y 
